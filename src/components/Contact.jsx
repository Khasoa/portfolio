...
export default function Contact() {
  ...
  const onFocus = e => { e.target.style.borderColor="rgba(240,168,152,0.5)"; e.target.style.background="rgba(255,255,255,0.07)" }
  const onBlur  = e => { e.target.style.borderColor="rgba(255,255,255,0.18)"; e.target.style.background="rgba(255,255,255,0.04)" }
  ...
  return (
    <section id="contact" className="s-wrap" style={{ padding:"64px 64px 56px", maxWidth:"1100px", margin:"0 auto" }}>
      ...
      <div className="contact-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1.5fr", gap:"64px", alignItems:"start" }}>
        ...
        <div>
          {sent ? (
            <div style={{ background:"var(--coral-dim)", border:"1px solid var(--coral-mid)", borderRadius:"8px", padding:"24px" }}>
              <p style={{ fontSize:"15px", fontWeight:500, color:"var(--coral)", marginBottom:"8px" }}>Message received.</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit"
                ...
                style={{
                  width:"100%",
                  background: hs ? "#d9897a" : "var(--coral)",
                  color:"#0f1117",
                  border:`1px solid ${hs ? "#d9897a" : "var(--coral)"}`,
